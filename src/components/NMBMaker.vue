...
export default {
  ...
  methods: {
    ...
    onPan(e) {
      //get absolute coordinates of pan position(x,y) in 'rem'
      // console.log((e.center.x/SCREEN_WIDTH)*10)
      console.log(e)
    }
  },
  created() {
...
<div id="app">
  <!-- <v-touch @pan="onPan"> -->
    <div class="keys" @touchstart.stop.prevent="touchStartHandler" @touchend.stop.event="touchEndHandler">
      ...
      <div @pointerout="onPan" :class="['white', 'c', activeNote.C4?'active-note':'']" id="C4"></div>
      <div @pointerenter="onPan" :class="['black', 'd-minor', activeNote.Db4?'active-note':'']" id="Db4"></div>
